...
export default function AIVisualizationPage() {
  ...
  const stepBadge = (s: Step, label: string) => (
    <Badge
      ...
      className={
        step === s
          ? "bg-violet-600 hover:bg-violet-600 text-white border-violet-500"
  ...
  return (
    <PageWrapper>
      <header className="bg-white/80 dark:bg-black/20 backdrop-blur-xl border-b border-violet-500/20 px-6 py-4">
      ...
      <main className="flex-1 p-6">
        {step === "upload" && (
          <div className="max-w-2xl mx-auto space-y-6">
            <Card className="bg-gray-50 dark:bg-gray-800/50 backdrop-blur-xl border border-violet-500/20 text-gray-900 dark:text-white hover-elevate">
              <CardHeader className="text-center">
                <div className="w-16 h-16 mx-auto rounded-xl bg-violet-500/10 backdrop-blur-md border border-violet-500/30 flex items-center justify-center mb-4">
              ...
              <CardContent>
                <div
                  className="border-2 border-dashed border-violet-500/30 rounded-lg p-8 text-center hover:border-violet-400/60 transition-colors cursor-pointer bg-violet-950/10 dark:bg-violet-950/20"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="bg-gray-50 dark:bg-gray-800/50 backdrop-blur-xl border border-violet-500/20 text-gray-900 dark:text-white hover-elevate">
                ...
                <CardContent>
                  <img
                    ...
                    alt="Chantier"
                    className="w-full h-64 object-cover rounded-lg border border-violet-500/20"
                    data-testid="uploaded-image-preview"
                  />
                  <Button
                    variant="outline"
                    size="sm"
                    className="mt-4 border-violet-500/30"
                    onClick={() => fileInputRef.current?.click()}
              ...
              <div className="space-y-6">
                      ...
                      <div
                        ...
                        className={`p-3 rounded-lg border cursor-pointer transition-all text-gray-900 dark:text-white ${
                          selectedWorkType === type.id
                            ...
                            : "border-violet-500/20 hover:border-violet-400/50 bg-violet-950/5"
                        }`}
                ...
                {selectedWorkType === "autre" && (
                  <Card className="bg-gray-50 dark:bg-gray-800/50 backdrop-blur-xl border border-violet-500/20 text-gray-900 dark:text-white">
                    <CardContent className="pt-6">
                      ...
                      <Input
                        ...
                        className="mt-2 border-violet-500/30"
                  ...
                  <Card className="bg-gray-50 dark:bg-gray-800/50 backdrop-blur-xl border border-violet-500/20 text-gray-900 dark:text-white hover-elevate">
                    ...
                    <CardContent>
                      <Textarea
                        ...
                        rows={3}
                        className="border-violet-500/30 resize-none"
        ...
        {step === "generating" && (
          <div className="max-w-2xl mx-auto space-y-6">
            <Card className="hover-elevate text-center border border-violet-500/20 bg-gray-50 dark:bg-gray-800/50">
              <CardHeader>
                <div className="w-16 h-16 mx-auto rounded-xl bg-violet-500/10 border border-violet-500/30 flex items-center justify-center mb-4">
              ...
              <CardContent className="space-y-4">
                <div className="h-2 w-full rounded-full bg-violet-950/30 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto space-y-6">
            <Card className="bg-gray-50 dark:bg-gray-800/50 backdrop-blur-xl border border-violet-500/20 text-gray-900 dark:text-white hover-elevate">
              <CardHeader className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-3">
                  <CheckCircle className="h-6 w-6 text-violet-400 shrink-0" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  <div className="lg:col-span-1 space-y-3">
                    ...
                    <img
                      src={uploadedImage.preview}
                      alt="Chantier"
                      className="w-full h-56 object-cover rounded-lg border border-violet-500/20"
                      data-testid="before-image"
                    />
                    <div className="text-sm space-y-1">
                      <p>
                        <span className="text-gray-600 dark:text-gray-300">Travaux :</span>{" "}
                        <span className="font-medium">{resolvedWorkLabel}</span>
                      </p>
                      <p>
                        <span className="text-gray-600 dark:text-gray-300">Objectif :</span>{" "}
                  ...
                  <div className="lg:col-span-2 space-y-4">
                    <section className="p-4 rounded-lg bg-violet-950/10 border border-violet-500/20">
                      <h3 className="font-semibold mb-2 flex items-center gap-2 text-violet-300">
                  ...
                  <section className="p-4 rounded-lg bg-violet-950/10 border border-violet-500/20">
                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-sm">
                        <thead>
                          <tr className="border-b border-violet-500/20 text-left text-gray-600 dark:text-gray-300">
                        ...
                        <tbody>
                          {report.lignes_devis.map((l, i) => (
                            <tr key={i} className="border-b border-violet-500/10">
