      ...
      <div className="container mx-auto">
        <div className="flex gap-8 py-12 lg:py-20 items-center justify-center flex-col">
            ...
            <h1 className="text-5xl md:text-7xl max-w-2xl tracking-tighter text-center font-regular">
              ...
              <span className="relative flex w-full justify-center overflow-hidden text-center md:pb-4 md:pt-1">
                ...
                {titles.map((title, index) => (
                  <motion.span
                    key={index}
                    className="absolute font-semibold bg-gradient-to-r from-blue-400 via-brand to-blue-600 bg-clip-text text-transparent"
          ...
          <div className="flex flex-row gap-3">
            ...
            <Button size="lg" className="gap-4 bg-white/20 backdrop-blur-md border border-border text-foreground hover:bg-white/30" data-testid="button-signup">
